@echo off
color 4
del /s /q "Clients\2007M\content\scripts\host.lua"
del /s /q "Clients\2007M\content\scripts\join.lua"
del /s /q "Clients\2007M\content\scripts\solo.lua"
title Roblox Server Tool 2007M
cls

echo Buildium Server tool (2007M) - Written by Disasterocks
echo.
echo 1. Host
echo 2. Join
...
cd..
cls
start BuildiumClient -script "content\scripts\join.lua"
sleep 5
exit
...
cd..
cls
start start BuildiumClient -script "content\scripts\host.lua"
sleep 5
exit