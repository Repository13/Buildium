@echo off
color 2
del /s /q "content\scripts\host.lua"
del /s /q "content\scripts\join.lua"
del /s /q "content\scripts\solo.lua"
title Roblox Server Tool 2008L
cls

echo Buildium Server tool (2008L) - Written by Disasterocks
echo.
echo 1. Host
echo 2. Join
